...
{
 "use strict";
 var SpaList,Client,WebSharper,Obj,UI,Var$1,Operators,Remoting,AjaxRemotingProvider,Collections,List,Server,Person,ListModel,Seq,Templating,Runtime,Server$1,TemplateInstance,Arrays,ProviderBuilder,Unchecked,SpaList_Templates,Doc,View,Handler,Var,ConcreteVar,Snap,JavaScript,Pervasives,Concurrency,SC$1,Enumerator,T,System,Guid,Array,Client$1,Templates,Abbrev,Fresh,AsyncBody,Dictionary,CT,JS,Object,AttrProxy,CheckedInput,Numeric,HashSet,TemplateInitializer,List$1,T$1,Async,DomUtility,Docs,DateUtil,EventTarget,Node,Scheduler,Storage,SC$2,DictionaryUtil,DocElemNode,CharacterData,SC$3,WindowOrWorkerGlobalScope,Error,OperationCanceledException,Json,SC$4,ArrayStorage,CancellationTokenSource,Elt,Attrs,Dyn,Prepare,Slice,KeyCollection,An,Settings,Mailbox,SC$5,Attrs$1,AttrModule,Strings,Updates,ValueCollection,Queue,Docs$1,RunState,NodeSet,Anims,SC$6,XhrProvider,HashSetUtil,BindVar,SC$7,SC$8,SC$9,AppendList,DynamicAttrNode,String,Easing,HashSet$1,Char,DomNodes,Lazy,SC$10,LazyExtensionsProxy,LazyRecord,IntelliFactory,Runtime$1,JSON,console,Math,Date;
 SpaList=Global.SpaList=Global.SpaList||{};
 Client=SpaList.Client=SpaList.Client||{};
 ...
 Server=SpaList.Server=SpaList.Server||{};
 Person=Server.Person=Server.Person||{};
 ...
 Server$1=Runtime.Server=Runtime.Server||{};
 TemplateInstance=Server$1.TemplateInstance=Server$1.TemplateInstance||{};
 Arrays=WebSharper.Arrays=WebSharper.Arrays||{};
 ProviderBuilder=Server$1.ProviderBuilder=Server$1.ProviderBuilder||{};
 Unchecked=WebSharper.Unchecked=WebSharper.Unchecked||{};
 SpaList_Templates=Global.SpaList_Templates=Global.SpaList_Templates||{};
 Doc=UI.Doc=UI.Doc||{};
 View=UI.View=UI.View||{};
 Handler=Server$1.Handler=Server$1.Handler||{};
 Var=UI.Var=UI.Var||{};
 ...
 SC$1=Global.StartupCode$SpaList$Client=Global.StartupCode$SpaList$Client||{};
 ...
 TemplateInitializer=Server$1.TemplateInitializer=Server$1.TemplateInitializer||{};
 ...
 SC$5=Global.StartupCode$WebSharper_Main$Remoting=Global.StartupCode$WebSharper_Main$Remoting||{};
 ...
 {
  var newName,newBirthday,b,x,b$1,a,b$2,t,_this,_this$1,L,_this$2,p,i;
  newName=Var$1.Create$1("");
  newBirthday=Var$1.Create$1("");
  Concurrency.Start((b=null,Concurrency.Delay(function()
  {
   return Concurrency.Bind((new AjaxRemotingProvider.New()).Async("SpaList:SpaList.Server.getAll:-1327522971",[]),function(a$1)
   {
    Client.People().Set(a$1);
    return Concurrency.Return(null);
   });
  })),null);
  Doc.EmbedView((x=View.MapAsync(Global.id,View.Const((b$1=null,Concurrency.Delay(function()
  {
   return Concurrency.Bind((new AjaxRemotingProvider.New()).Async("SpaList:SpaList.Server.getAll:-1327522971",[]),function(a$1)
   {
    return Concurrency.Return(Doc.Concat(Seq.map(function(person)
    {
     var b$3,_this$3,p$1,i$1;
     return(b$3=(_this$3=new ProviderBuilder.New$1(),(_this$3.h.push({
      $:1,
      $0:"name",
      $1:person.Name
     }),_this$3)),(p$1=Handler.CompleteHoles(b$3.k,b$3.h,[]),(i$1=new TemplateInstance.New(p$1[1],SpaList_Templates.listitem(p$1[0])),b$3.i=i$1,i$1))).get_Doc();
    },a$1)));
   });
  })))),View.WithInit(Doc.Element("p",[],[Doc.TextNode("loading...")]),x)));
  a=(b$2=(t=(_this=(_this$1=(L=Doc.BindView(function(people)
  {
   return Doc.Concat(Seq.map(function(p$1)
   {
    var b$3,B,_this$3,_this$4,p$2,i$1;
    return(b$3=(B=(new Global.Date(p$1.Birthday)).toLocaleDateString(),(_this$3=(_this$4=new ProviderBuilder.New$1(),(_this$4.h.push({
     $:1,
     $0:"name",
     $1:p$1.Name
     ...
     $0:"birthday",
     $1:B
    }),_this$3))),(p$2=Handler.CompleteHoles(b$3.k,b$3.h,[]),(i$1=new TemplateInstance.New(p$2[1],SpaList_Templates.listitem(p$2[0])),b$3.i=i$1,i$1))).get_Doc();
   },people));
  },Client.People().v),(_this$2=new ProviderBuilder.New$1(),(_this$2.h.push({
   $:0,
   $0:"listcontainer",
   $1:L
  ...
  {
   var person,b$3;
   person=Person.Init$1(newName.Get(),newBirthday.Get());
   Client.People().Append(person);
   newName.Set("");
   newBirthday.Set("");
   Concurrency.Start((b$3=null,Concurrency.Delay(function()
   {
    return Concurrency.Bind((new AjaxRemotingProvider.New()).Async("SpaList:SpaList.Server.add:1223450582",[person]),function()
    {
     return Concurrency.Return(null);
    });
   })),null);
  })),t)),(p=Handler.CompleteHoles(b$2.k,b$2.h,[["name",0],["birthday",0]]),(i=new TemplateInstance.New(p[1],SpaList_Templates.main(p[0])),b$2.i=i,i))).get_Doc();
 ...
 Person.Init$1=function(name,date)
 {
  return Person.New(name,DateUtil.Parse(date));
 };
 Person.New=function(Name,Birthday)
 {
  return{
   Name:Name,
   Birthday:Birthday
 ...
 TemplateInstance=Server$1.TemplateInstance=Runtime$1.Class({
  get_Doc:function()
  {
   return this.doc;
  }
 ...
 ProviderBuilder=Server$1.ProviderBuilder=Runtime$1.Class({},Obj,ProviderBuilder);
 ...
 SpaList_Templates.listitem=function(h)
 {
 ...
 SpaList_Templates.main=function(h)
 {
  Templates.LoadLocalTemplates("index");
  return h?Templates.NamedTemplate("index",{
   $:1,
 ...
 SC$1.$cctor=function()
 {
  ...
  SC$1.People=ListModel.Create(function(p)
  {
   return p.Name;
  },[]);
 };
 ...
 TemplateInitializer=Server$1.TemplateInitializer=Runtime$1.Class({},Obj,TemplateInitializer);
 ...
 SC$5.$cctor=function()
 {
  ...
  SC$5.EndPoint="?";
  SC$5.AjaxProvider=new XhrProvider.New();
 };
